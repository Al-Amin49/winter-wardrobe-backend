...
*/
 const getAllClothes= asyncHandler(async(req, res)=>{
    ...
    res
    .status(200)
    .json(new ApiResponse(200, allClothes, "All clothes fetched Succesfully"));
 })
 /*-------------------
...
*/
 ...
 const singleClothe = await Clothe.findById(req.params.id);
    ...
    res
    .status(200)
    .json(new ApiResponse(200, singleClothe, "Single clothe fetched Succesfully"));
 })
 /*-------------------
...
*/
 const deleteClothe= asyncHandler(async(req, res)=>{
    ...
    res
    .status(200)
    .json(new ApiResponse(200, {}, "clothe deleted Succesfully"));
 })
